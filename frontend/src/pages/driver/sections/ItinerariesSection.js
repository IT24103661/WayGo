  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-col gap-2">
        ...
        <p className="text-slate-500">Pre-booked tours scheduled for you.</p>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {itineraries.map(item => (
          <div key={item.id} className="bg-white/90 backdrop-blur-sm rounded-3xl p-6 shadow-[0_20px_45px_-35px_rgba(20,184,166,0.2)] border border-slate-200">
